    ...
    var content =
        '<div id="buswrap">'+
            ...
            '<div id="busbody">'+
                ...
                '</div>'+
                '<div id="busetc">'+
                    '• 운행시간 - 08:00 ~ 19:00 <span>(주말 및 공휴일 제외)</span><br>• 표시되는 시간은 버스시간표를 기준으로 안내중이며<br><a>시간대 별로 상이할 수 있습니다.</a>'+
                '</div>'+
            '</div>'+
        '</div>';
        var content1 =
        ...
        '<div id="buswrap">'+
            ...
            '<div id="busbody">'+
                '<div id="businfo" class="clearfix">'+
                    ...
                    '</div>'+
                    '<div id="businforight">'+
                        '<strong>B</strong><br>(<a>시계</a> 방향)<br><p id="BtimeStud">로딩 중</p>'+
                    '</div>'+
                '</div>'+
                '<div id="busetc">'+
                    '• 운행시간 - 08:00 ~ 19:00 <span>(주말 및 공휴일 제외)</span><br>• 표시되는 시간은 버스시간표를 기준으로 안내중이며<br><a>시간대 별로 상이할 수 있습니다.</a>'+
        ...
        '<div id="buswrap">'+
            ...
            '<div id="busbody">'+
                '<div id="businfo" class="clearfix">'+
                    '<div id="businfoleft">'+
                        '<strong>A</strong><br>(<a>반시계</a> 방향)<br><p id="AtimeHumanE">로딩 중</p>'+
                    '</div>'+
                    '<div id="businforight">'+
                        '<strong>B</strong><br>(<a>시계</a> 방향)<br><p id="BtimeHumanE">로딩 중</p>'+
                    '</div>'+
                '</div>'+
                '<div id="busetc">'+
                    '• 운행시간 - 08:00 ~ 19:00 <span>(주말 및 공휴일 제외)</span><br>• 표시되는 시간은 버스시간표를 기준으로 안내중이며<br><a>시간대 별로 상이할 수 있습니다.</a>'+
        ...
        '<div id="buswrap">'+
            ...
            '<div id="busbody">'+
                '<div id="businfo" class="clearfix">'+
                    ...
                    '</div>'+
                    '<div id="businforight">'+
                        '<strong>B</strong><br>(<a>시계</a> 방향)<br><p id="BtimeLib">로딩 중</p>'+
                    '</div>'+
                '</div>'+
                '<div id="busetc">'+
                    '• 운행시간 - 08:00 ~ 19:00 <span>(주말 및 공휴일 제외)</span><br>• 표시되는 시간은 버스시간표를 기준으로 안내중이며<br><a>시간대 별로 상이할 수 있습니다.</a>'+
        ...
        '<div id="buswrap">'+
            ...
            '<div id="busbody">'+
                '<div id="businfo" class="clearfix">'+
                    ...
                    '</div>'+
                    '<div id="businforight">'+
                        '<strong>B</strong><br>(<a>시계</a> 방향)<br><p id="BtimeMedi">로딩 중</p>'+
                    '</div>'+
                '</div>'+
                '<div id="busetc">'+
                    '• 운행시간 - 08:00 ~ 19:00 <span>(주말 및 공휴일 제외)</span><br>• 표시되는 시간은 버스시간표를 기준으로 안내중이며<br><a>시간대 별로 상이할 수 있습니다.</a>'+
        ...
        '<div id="buswrap">'+
            ...
            '<div id="busbody">'+
                '<div id="businfo" class="clearfix">'+
                    '<div id="businfoleft">'+
                        '<strong>A</strong><br>(<a>반시계</a> 방향)<br><p id="AtimeMain">로딩 중</p>'+
                    '</div>'+
                    '<div id="businforight">'+
                        '<strong>B</strong><br>(<a>시계</a> 방향)<br><p id="BtimeMain">로딩 중</p>'+
                    '</div>'+
                '</div>'+
                '<div id="busetc">'+
                    '• 운행시간 - 08:00 ~ 19:00 <span>(주말 및 공휴일 제외)</span><br>• 표시되는 시간은 버스시간표를 기준으로 안내중이며<br><a>시간대 별로 상이할 수 있습니다.</a>'+
