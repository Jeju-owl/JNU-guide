...
'<div id="marketwrap">'+
        ...
        '<div id="marketmenu" style="background-image: url("https://raw.githubusercontent.com/Jeju-owl/JNU-guide/feature-7/images/%EC%B1%A8%EB%A6%AC%EC%8A%A4.jpg"); background-size: 100% 100%;"></div>'+
        '<div id="marketinfo">'+
...
'<div id="marketwrap">'+
        ...
        '<div id="marketmenu" style="background-image: url("https://raw.githubusercontent.com/Jeju-owl/JNU-guide/feature-7/images/%EC%9A%B0%ED%96%A5.jpg"); background-size: 100% 100%;"></div>'+
        '<div id="marketinfo">'+
            '<p><i class="icon-calendar"></i><b> 영업일</b><br>월,화,수,목,금<a> (휴일 및 공휴일 제외)</a></p>'+
            '<p><i class="icon-clock"></i><b> 영업시간</b><br>08:00 ~ 16:00</p>'+
        '</div>'+
