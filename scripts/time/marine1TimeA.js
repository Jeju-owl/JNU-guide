function marine1TimeA() {
  if (document.querySelector("#AtimeMarine1")?.innerHTML === undefined) return;
  var now = new Date();
  ...
  if (nowHour >= 19 || now.getDay() == 0 || now.getDay() == 6 || nowHour <= 6) {
    ...
    if (nowHour == 18) {
      if (nowMinute > 42) {
        ...
        document.querySelector("#AtimeMarine1").innerHTML =
          Number(42 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 22 && nowMinute > 2) {
        document.querySelector("#AtimeMarine1").innerHTML =
          Number(22 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 2) {
        document.querySelector("#AtimeMarine1").innerHTML =
          Number(2 - nowMinute) + ":" + Number(59 - nowSecond);
      }
    } else if (nowHour == 17) {
      if (nowMinute > 42) {
        document.querySelector("#AtimeMarine1").innerHTML =
          Number(62 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 42 && nowMinute > 22) {
        document.querySelector("#AtimeMarine1").innerHTML =
          Number(42 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 22 && nowMinute > 2) {
      ...
      if (nowMinute > 47) {
        document.querySelector("#AtimeMarine1").innerHTML =
          Number(82 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 47 && nowMinute > 27) {
        document.querySelector("#AtimeMarine1").innerHTML =
          Number(47 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 27 && nowMinute > 7) {
