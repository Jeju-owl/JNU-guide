function humanWestTimeA() {
  if (document.querySelector("#AtimeHumanW")?.innerHTML === undefined) return;
  var now = new Date();
  ...
  if (nowHour >= 19 || now.getDay() == 0 || now.getDay() == 6 || nowHour <= 6) {
    ...
    if (nowHour == 18) {
      if (nowMinute > 45) {
        ...
        document.querySelector("#AtimeHumanW").innerHTML =
      ...
      if (nowMinute > 50) {
        document.querySelector("#AtimeHumanW").innerHTML =
          Number(95 - nowMinute) + ":" + Number(59 - nowSecond);
      ...
      if (nowMinute > 25) {
        if (nowMinute <= 45 && nowMinute > 25) {
          ...
          document.querySelector("#AtimeHumanW").innerHTML =
            Number(105 - nowMinute) + ":" + Number(59 - nowSecond);
        }
      ...
      if (nowMinute > 50) {
        document.querySelector("#AtimeHumanW").innerHTML =
          Number(85 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 50 && nowMinute > 30) {
        document.querySelector("#AtimeHumanW").innerHTML =
          Number(50 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 30 && nowMinute > 10) {
