function dormitoryTimeB() {
  if (document.querySelector("#BtimeDrom")?.innerHTML === undefined) return;
  var now = new Date();
  ...
  if (nowHour >= 19 || now.getDay() == 0 || now.getDay() == 6 || nowHour <= 6) {
    ...
    if (nowHour == 18) {
      if (nowMinute > 58) {
        ...
        document.querySelector("#BtimeDrom").innerHTML =
          Number(58 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 38 && nowMinute > 18) {
        document.querySelector("#BtimeDrom").innerHTML =
          Number(38 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 18) {
        document.querySelector("#BtimeDrom").innerHTML =
          Number(18 - nowMinute) + ":" + Number(59 - nowSecond);
      }
    } else if (nowHour == 17) {
      if (nowMinute > 58) {
        document.querySelector("#BtimeDrom").innerHTML =
          Number(78 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 58 && nowMinute > 38) {
        document.querySelector("#BtimeDrom").innerHTML =
          Number(58 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 38 && nowMinute > 18) {
      ...
      if (nowMinute > 58) {
        document.querySelector("#BtimeDrom").innerHTML =
          Number(108 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 58 && nowMinute > 38) {
        document.querySelector("#BtimeDrom").innerHTML =
          Number(58 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 38 && nowMinute > 18) {
      ...
      if (nowMinute > 38) {
        if (nowMinute <= 58 && nowMinute > 38) {
          ...
          document.querySelector("#BtimeDrom").innerHTML =
            Number(118 - nowMinute) + ":" + Number(59 - nowSecond);
        }
      ...
      if (nowMinute > 58) {
        document.querySelector("#BtimeDrom").innerHTML =
          Number(98 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 58 && nowMinute > 38) {
        document.querySelector("#BtimeDrom").innerHTML =
          Number(58 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 38 && nowMinute > 18) {
