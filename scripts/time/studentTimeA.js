  ...
  if (nowHour >= 19 || now.getDay() == 0 || now.getDay() == 6 || nowHour <= 6) {
    ...
    if (nowHour == 18) {
      if (nowMinute > 44) {
        ...
        document.querySelector("#AtimeStud").innerHTML =
          Number(44 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 24 && nowMinute > 4) {
        document.querySelector("#AtimeStud").innerHTML =
          Number(24 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 4) {
        document.querySelector("#AtimeStud").innerHTML =
          Number(4 - nowMinute) + ":" + Number(59 - nowSecond);
      }
    } else if (nowHour == 17) {
      if (nowMinute > 44) {
        document.querySelector("#AtimeStud").innerHTML =
          Number(64 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 44 && nowMinute > 24) {
        document.querySelector("#AtimeStud").innerHTML =
          Number(44 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 24 && nowMinute > 4) {
      ...
      if (nowMinute > 49) {
        document.querySelector("#AtimeStud").innerHTML =
          Number(84 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 49 && nowMinute > 29) {
        document.querySelector("#AtimeStud").innerHTML =
          Number(49 - nowMinute) + ":" + Number(59 - nowSecond);
      } else if (nowMinute <= 29 && nowMinute > 9) {
